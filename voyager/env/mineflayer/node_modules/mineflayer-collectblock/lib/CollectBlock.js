            ...
            try {
                switch (closest.constructor.name) {
                    case 'Block': {
                        ...
                        console.log("collectAll: Attempting to pathfind to block");
                        yield bot.pathfinder.goto(goal);
                        console.log("collectAll: Successfully pathfound to block");
                    ...
                    case 'Entity': {
                        ...
                        console.log("collectAll: Attempting to follow entity");
                        yield bot.pathfinder.goto(new mineflayer_pathfinder_1.goals.GoalFollow(closest, 0));
                        console.log("collectAll: Successfully following entity");
                        yield waitForPickup;
                        break;
                    }
                    default: {
