            ...
            try {
                switch (closest.constructor.name) {
                    case 'Block': {
                        ...
                        console.log("collectAll: Attempting to pathfind to block:", closest.position);
                        yield bot.pathfinder.goto(goal);
                        console.log("collectAll: Successfully pathfound to block:", closest.position);
                    ...
                    case 'Entity': {
                        ...
                        console.log("collectAll: Attempting to follow entity:", closest);
                        yield bot.pathfinder.goto(new mineflayer_pathfinder_1.goals.GoalFollow(closest, 0));
                        console.log("collectAll: Successfully following entity:", closest);
                        yield waitForPickup;
                        break;
                    }
                    default: {
                ...
                console.error("collectAll: Pathfinding error:", error);
                if (options.ignoreNoPath) {
                    console.log("collectAll: No path found. Removing target.");
