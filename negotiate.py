...
task1 = ("Maximize points where 'iron ore' is worth 3 and 'diamond ore' is worth 5. "
         "Points are calculated at the end of the game by resources in the player inventory.")
task2 = ("Maximize points where 'iron ore' is worth 4 and 'diamond ore' is worth 4. "
